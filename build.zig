...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "babylon" is the name you will use in your source code to
                // import this module (e.g. `@import("babylon")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "babylon", .module = mod },
                .{ .name = "flash", .module = flash.module("flash") },
                .{ .name = "zcrypto", .module = zcrypto.module("zcrypto") },
                .{ .name = "zpack", .module = zpack.module("zpack") },
                .{ .name = "zhttp", .module = zhttp.module("zhttp") },
    ...
    const demo_run_step = b.step("demo", "Run the cache demo");
